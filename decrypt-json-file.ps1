...
$branchName = "main"
$filePath = "jsonfile/encrypt.json"
...
$targetBranchName = "decrypt/jsonfile"  # The branch where you want to create/update the file
$targetFilePath = "decrypt-jsonfile/decrypt-jsonfiledata.json"  # Replace with the actual file path in the target branch
